...
> The website is a Single Page App that allows users to make simple calculations and read a random math-related quote. This is built using CSS, JavaScript and React JS.
...
>  Built with React JS, CSS and JavaScript with webpack, jest, and linter configuration setup.
...
``` 
  $ git clone https://github.com/lenkon/math-magician
